...
// Constructor
//
// `el` _(Optional)_: _[Object: DOM Element]_ If no element is passed, a `div`
// element will be created and used, but also detached from the `document.body`
// (so is invisible) by default

var dal = function (el) {
  dal.DOM = el ? el : document.createElement('div');
}
